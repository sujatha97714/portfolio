        ...
        <div className={css.container}>
            <div className={`${css['timeline-block']} ${css['timeline-block-right']}`}>
                ...
                <div className={css['timeline-content']}>
                    ...
                    <p>Skills: Typescript, React, AWS, Cypress, Figma, Styled Components</p>
                </div>
            </div>
            ...
            <div className={`${css['timeline-block']} ${css['timeline-block-left']}`}>
                ...
                <div className={css['timeline-content']}>
                    ...
                    <p>Skills: React, AWS Services, SQL, GraphQL, Terraform, React Native</p>
                </div>
            </div>
            ...
            <div className={`${css['timeline-block']} ${css['timeline-block-right']}`}>
                ...
                <div className={css['timeline-content']}>
                    ...
                    <p>Skills: Javascript, React, Redux, Jest, GraphQL, RabbitMQ </p>
                </div>
            </div>
            ...
            <div className={`${css['timeline-block']} ${css['timeline-block-left']}`}>
                ...
                <div className={css['timeline-content']}>
                    ...
                    <p>Skills: React, Redux, Node, Express Js, D3.js, SQLite, Jenkins, Python, Java, C# (WPF) </p>
                </div>
            </div>
        </div>
